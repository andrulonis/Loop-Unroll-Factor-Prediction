...
for.end:                                          ; preds = %for.body7
  ...
  %exitcond10 = icmp ne i64 %indvars.iv.next8, 32
  br i1 %exitcond10, label %for.body, label %for.end43
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @buildNeighborList(i32* %position_x, i32* %position_y, i32* %position_z, [32 x i32]* %NL) #0 {
entry:
  %currList = alloca [32 x i32], align 16
  %currDist = alloca [32 x i32], align 16
  %arraydecay = getelementptr inbounds [32 x i32], [32 x i32]* %currDist, i64 0, i64 0
...
for.body3:                                        ; preds = %for.body, %for.body3
  ...
  %arrayidx = getelementptr inbounds [32 x i32], [32 x i32]* %currList, i64 0, i64 %indvars.iv
  store i32 0, i32* %arrayidx, align 4
  %arrayidx5 = getelementptr inbounds [32 x i32], [32 x i32]* %currDist, i64 0, i64 %indvars.iv
  store i32 999999999, i32* %arrayidx5, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp ne i64 %indvars.iv.next, 32
  br i1 %exitcond, label %for.body3, label %for.body8.preheader
...
if.end:                                           ; preds = %for.body8
  ...
  %arrayidx11 = getelementptr inbounds [32 x i32], [32 x i32]* %currList, i64 0, i64 %indvars.iv6
  %2 = trunc i64 %indvars.iv6 to i32
  store i32 %2, i32* %arrayidx11, align 4
  %arrayidx13 = getelementptr inbounds [32 x i32], [32 x i32]* %currDist, i64 0, i64 %indvars.iv6
  store i32 %call, i32* %arrayidx13, align 4
  br label %for.inc14

for.inc14:                                        ; preds = %for.body8, %if.end
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %exitcond8 = icmp ne i64 %indvars.iv.next7, 32
  br i1 %exitcond8, label %for.body8, label %for.end16

for.end16:                                        ; preds = %for.inc14
  %3 = trunc i64 %indvars.iv9 to i32
  %call18 = call i32 @populateNeighborList(i32* nonnull %arraydecay, i32* nonnull %arraydecay17, i32 %3, [32 x i32]* %NL)
  %add = add nsw i32 %totalPairs.04, %call18
  %indvars.iv.next10 = add nuw nsw i64 %indvars.iv9, 1
  %exitcond11 = icmp ne i64 %indvars.iv.next10, 32
  br i1 %exitcond11, label %for.body, label %for.end21
...
; Function Attrs: noinline nounwind uwtable
define dso_local i32 @populateNeighborList(i32* %currDist, i32* %currList, i32 %i, [32 x i32]* %NL) #0 {
entry:
  br label %for.body
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %arrayidx = getelementptr inbounds [32 x i32], [32 x i32]* %position_x, i64 0, i64 %indvars.iv21
  store i32 %call, i32* %arrayidx, align 4
  %call1 = call i32 @rand() #4
  %arrayidx3 = getelementptr inbounds [32 x i32], [32 x i32]* %position_y, i64 0, i64 %indvars.iv21
  store i32 %call1, i32* %arrayidx3, align 4
  %call4 = call i32 @rand() #4
  %arrayidx6 = getelementptr inbounds [32 x i32], [32 x i32]* %position_z, i64 0, i64 %indvars.iv21
  store i32 %call4, i32* %arrayidx6, align 4
  %indvars.iv.next22 = add nuw nsw i64 %indvars.iv21, 1
  %exitcond23 = icmp ne i64 %indvars.iv.next22, 32
  br i1 %exitcond23, label %for.body, label %for.body9.preheader

for.body9.preheader:                              ; preds = %for.body
  br label %for.body9

for.body9:                                        ; preds = %for.body9.preheader, %for.inc20
  %indvars.iv18 = phi i64 [ 0, %for.body9.preheader ], [ %indvars.iv.next19, %for.inc20 ]
  br label %for.body12

for.body12:                                       ; preds = %for.body9, %for.body12
  %indvars.iv15 = phi i64 [ 0, %for.body9 ], [ %indvars.iv.next16, %for.body12 ]
  %arrayidx16 = getelementptr inbounds [32 x [32 x i32]], [32 x [32 x i32]]* %NL, i64 0, i64 %indvars.iv18, i64 %indvars.iv15
  store i32 0, i32* %arrayidx16, align 4
  %indvars.iv.next16 = add nuw nsw i64 %indvars.iv15, 1
  %exitcond17 = icmp ne i64 %indvars.iv.next16, 32
  br i1 %exitcond17, label %for.body12, label %for.inc20

for.inc20:                                        ; preds = %for.body12
  %indvars.iv.next19 = add nuw nsw i64 %indvars.iv18, 1
  %exitcond20 = icmp ne i64 %indvars.iv.next19, 32
  br i1 %exitcond20, label %for.body9, label %for.end22
...
for.body32:                                       ; preds = %for.body29, %for.body32
  %indvars.iv7 = phi i64 [ 0, %for.body29 ], [ %indvars.iv.next8, %for.body32 ]
  %arrayidx36 = getelementptr inbounds [32 x [32 x i32]], [32 x [32 x i32]]* %NL, i64 0, i64 %indvars.iv11, i64 %indvars.iv7
  ...
  %indvars.iv.next8 = add nuw nsw i64 %indvars.iv7, 1
  %exitcond10 = icmp ne i64 %indvars.iv.next8, 32
  br i1 %exitcond10, label %for.body32, label %for.inc42

for.inc42:                                        ; preds = %for.body32
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond14 = icmp ne i64 %indvars.iv.next12, 32
  br i1 %exitcond14, label %for.body29, label %for.end44
...
for.end44:                                        ; preds = %for.inc42
  ...
  %arraydecay48 = getelementptr inbounds [32 x i32], [32 x i32]* %position_x, i64 0, i64 0
  %arraydecay49 = getelementptr inbounds [32 x i32], [32 x i32]* %position_y, i64 0, i64 0
  %arraydecay50 = getelementptr inbounds [32 x i32], [32 x i32]* %position_z, i64 0, i64 0
...
for.body54:                                       ; preds = %for.end44, %for.body54
  ...
  %4 = load i32, i32* %arrayidx58, align 4
  %arrayidx60 = getelementptr inbounds [32 x i32], [32 x i32]* %force_z, i64 0, i64 %indvars.iv
  %5 = load i32, i32* %arrayidx60, align 4
  %call61 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i32 %3, i32 %4, i32 %5) #4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp ne i64 %indvars.iv.next, 32
