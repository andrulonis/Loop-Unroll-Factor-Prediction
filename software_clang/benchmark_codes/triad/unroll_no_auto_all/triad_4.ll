...
for.body:                                         ; preds = %for.body, %entry
  ...
  %exitcond.3 = icmp ne i64 %indvars.iv.next.3, 2048
  br i1 %exitcond.3, label %for.body, label %for.end, !llvm.loop !2
...
for.body:                                         ; preds = %for.body, %entry
  %indvars.iv3 = phi i64 [ 0, %entry ], [ %indvars.iv.next4.3, %for.body ]
  ...
  %exitcond.35 = icmp ne i64 %indvars.iv.next4.3, 2048
  br i1 %exitcond.35, label %for.body, label %for.end, !llvm.loop !4
...
for.body18:                                       ; preds = %for.body18, %for.end
  %indvars.iv = phi i64 [ 0, %for.end ], [ %indvars.iv.next.3, %for.body18 ]
  ...
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv.next.2, 1
  %exitcond.3 = icmp ne i64 %indvars.iv.next.3, 2048
  br i1 %exitcond.3, label %for.body18, label %for.end24, !llvm.loop !5
