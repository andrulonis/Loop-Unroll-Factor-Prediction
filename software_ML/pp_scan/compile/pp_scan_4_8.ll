; ModuleID = 'pp_scan_4_8.ll'
source_filename = "pp_scan_4_8.c"
...
for.body3:                                        ; preds = %for.body3, %for.body
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next.7, %for.body3 ]
  ...
  br i1 %exitcond.7, label %for.body3, label %for.inc11, !llvm.loop !6
