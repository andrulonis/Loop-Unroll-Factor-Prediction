; ModuleID = 'pp_scan_1_2.ll'
source_filename = "pp_scan_1_2.c"
...
for.body3:                                        ; preds = %for.body3.1, %for.body
  ...
  br i1 %exitcond, label %for.body3.1, label %for.inc9, !llvm.loop !2

for.inc9:                                         ; preds = %for.body3
  %indvars.iv.next7 = add nuw nsw i64 %indvars.iv6, 1
  %exitcond12 = icmp ne i64 %indvars.iv.next7, 524288
  br i1 %exitcond12, label %for.body, label %for.end11, !llvm.loop !4
