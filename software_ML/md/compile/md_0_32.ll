...
for.body:                                         ; preds = %for.end.31, %entry
  %indvars.iv7 = phi i64 [ 0, %entry ], [ %indvars.iv.next8.31, %for.end.31 ]
...
for.end.31:                                       ; preds = %for.body7.31
  ...
  %exitcond10.31 = icmp ne i64 %indvars.iv.next8.31, 1024
  br i1 %exitcond10.31, label %for.body, label %for.end43, !llvm.loop !4
}
