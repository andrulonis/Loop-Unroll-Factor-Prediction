; ModuleID = 'stencil_0_16.ll'
source_filename = "stencil_0_16.c"
...
for.body:                                         ; preds = %for.inc78.15, %entry
  %indvars.iv12 = phi i64 [ 0, %entry ], [ %indvars.iv.next13.15, %for.inc78.15 ]
  br label %for.body3
...
for.inc78.13:                                     ; preds = %for.body3.13
  ...
  %exitcond15.13 = icmp ne i64 %indvars.iv.next13.13, 4094
  br i1 %exitcond15.13, label %for.body.14, label %for.end80, !llvm.loop !4

for.body.14:                                      ; preds = %for.inc78.13
  br label %for.body3.14

for.body3.14:                                     ; preds = %for.body3.14, %for.body.14
  %indvars.iv.14 = phi i64 [ 0, %for.body.14 ], [ %indvars.iv.next.14, %for.body3.14 ]
...
!4 = distinct !{!4, !5}
!5 = !{!"llvm.loop.unroll.count", i32 16}
!6 = distinct !{!6, !7}
