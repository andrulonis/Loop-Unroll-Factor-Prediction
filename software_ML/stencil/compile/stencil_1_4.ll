; ModuleID = 'stencil_1_4.ll'
source_filename = "stencil_1_4.c"
...
for.body3:                                        ; preds = %for.body3.2, %for.body
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next.3, %for.body3.2 ]
  ...
  br i1 %exitcond.1, label %for.body3.2, label %for.inc78, !llvm.loop !2
