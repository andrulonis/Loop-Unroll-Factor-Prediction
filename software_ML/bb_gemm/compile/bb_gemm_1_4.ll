; ModuleID = 'bb_gemm_1_4.ll'
source_filename = "bb_gemm_1_4.c"
...
for.body3:                                        ; preds = %for.inc17.3, %for.body
  %indvars.iv6 = phi i64 [ 0, %for.body ], [ %indvars.iv.next7.3, %for.inc17.3 ]
...
for.inc20:                                        ; preds = %for.inc17.3
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond21 = icmp ne i64 %indvars.iv.next12, 1024
  br i1 %exitcond21, label %for.body, label %for.end22, !llvm.loop !4
...
for.inc17.3:                                      ; preds = %for.body6.3
  ...
  br i1 %exitcond10.3, label %for.body3, label %for.inc20, !llvm.loop !5
}
