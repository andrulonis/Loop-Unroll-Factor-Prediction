; ModuleID = 'bb_gemm_base.ll'
source_filename = "bb_gemm_base.c"
...
for.inc20:                                        ; preds = %for.inc17
  ...
  %exitcond15 = icmp ne i64 %indvars.iv.next12, 1024
  br i1 %exitcond15, label %for.body, label %for.end22, !llvm.loop !5
