; ModuleID = 'bb_gemm_1_16.ll'
source_filename = "bb_gemm_1_16.c"
...
for.body3:                                        ; preds = %for.inc17.15, %for.body
  %indvars.iv6 = phi i64 [ 0, %for.body ], [ %indvars.iv.next7.15, %for.inc17.15 ]
...
for.inc20:                                        ; preds = %for.inc17.15
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond45 = icmp ne i64 %indvars.iv.next12, 1024
  br i1 %exitcond45, label %for.body, label %for.end22, !llvm.loop !4
...
for.inc17.15:                                     ; preds = %for.body6.15
  ...
  br i1 %exitcond10.15, label %for.body3, label %for.inc20, !llvm.loop !5
}
