...
# Put this file in the directory of all benchmark programs' directories ("benchmark_codes"), next to the "hyperfine_analysis.py" file
...
if args.title:
    plt.title("Execution times of loop " + args.title)
