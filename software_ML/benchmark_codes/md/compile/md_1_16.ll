...
for.body7:                                        ; preds = %for.body7, %for.body
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next.15, %for.body7 ]
  %fz.04 = phi i32 [ 0, %for.body ], [ %add34.15, %for.body7 ]
  %fy.03 = phi i32 [ 0, %for.body ], [ %add32.15, %for.body7 ]
  %fx.02 = phi i32 [ 0, %for.body ], [ %add30.15, %for.body7 ]
  ...
  br i1 %exitcond.15, label %for.body7, label %for.end, !llvm.loop !2

for.end:                                          ; preds = %for.body7
  %add30.lcssa = phi i32 [ %add30.15, %for.body7 ]
  %add32.lcssa = phi i32 [ %add32.15, %for.body7 ]
  %add34.lcssa = phi i32 [ %add34.15, %for.body7 ]
