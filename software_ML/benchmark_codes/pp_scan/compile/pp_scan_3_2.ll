; ModuleID = 'pp_scan_3_2.ll'
source_filename = "pp_scan_3_2.c"
...
for.inc11.1:                                      ; preds = %for.body3.1
  ...
  %exitcond10.1 = icmp ne i64 %indvars.iv.next6.1, 524288
  br i1 %exitcond10.1, label %for.body, label %for.end13, !llvm.loop !7
}
