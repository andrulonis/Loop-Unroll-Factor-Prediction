; ModuleID = 'ss_sort_5_32.ll'
source_filename = "ss_sort_5_32.c"
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %exitcond.31 = icmp ne i64 %indvars.iv.next.31, 16777216
  br i1 %exitcond.31, label %for.body, label %for.end, !llvm.loop !8
