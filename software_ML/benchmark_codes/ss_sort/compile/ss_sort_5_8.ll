; ModuleID = 'ss_sort_5_8.ll'
source_filename = "ss_sort_5_8.c"
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %exitcond.7 = icmp ne i64 %indvars.iv.next.7, 16777216
  br i1 %exitcond.7, label %for.body, label %for.end, !llvm.loop !8
