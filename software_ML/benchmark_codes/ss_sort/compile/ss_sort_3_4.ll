; ModuleID = 'ss_sort_3_4.ll'
source_filename = "ss_sort_3_4.c"
...
for.body:                                         ; preds = %for.inc11.3, %entry
  %indvars.iv5 = phi i64 [ 0, %entry ], [ %indvars.iv.next6.3, %for.inc11.3 ]
  br label %for.body3
...
for.inc11.3:                                      ; preds = %for.body3.3
  ...
  %exitcond10.3 = icmp ne i64 %indvars.iv.next6.3, 524288
  br i1 %exitcond10.3, label %for.body, label %for.end13, !llvm.loop !7
}
