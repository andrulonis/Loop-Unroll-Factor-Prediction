; ModuleID = 'bb_gemm_0_8.ll'
source_filename = "bb_gemm_0_8.c"
...
for.body:                                         ; preds = %for.inc20.7, %entry
  %indvars.iv11 = phi i64 [ 0, %entry ], [ %indvars.iv.next12.7, %for.inc20.7 ]
  br label %for.body3
...
for.inc20.7:                                      ; preds = %for.inc17.7
  ...
  %exitcond15.7 = icmp ne i64 %indvars.iv.next12.7, 1024
  br i1 %exitcond15.7, label %for.body, label %for.end22, !llvm.loop !5
}
