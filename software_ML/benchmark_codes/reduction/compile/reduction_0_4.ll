; ModuleID = 'reduction_0_4.ll'
source_filename = "reduction_0_4.c"
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %sum.02 = phi i32 [ 0, %entry ], [ %add.3, %for.body ]
  ...
  %exitcond.3 = icmp ne i64 %indvars.iv.next.3, 8388608
  br i1 %exitcond.3, label %for.body, label %for.end, !llvm.loop !2

for.end:                                          ; preds = %for.body
  %add.lcssa = phi i32 [ %add.3, %for.body ]
  ret i32 %add.lcssa
}
