; ModuleID = 'ss_sort_0_2.ll'
source_filename = "ss_sort_0_2.c"
...
for.inc9.1:                                       ; preds = %for.body3.1
  ...
  %exitcond10.1 = icmp ne i64 %indvars.iv.next7.1, 524288
  br i1 %exitcond10.1, label %for.body, label %for.end11, !llvm.loop !4
}
