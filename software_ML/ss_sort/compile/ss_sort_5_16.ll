; ModuleID = 'ss_sort_5_16.ll'
source_filename = "ss_sort_5_16.c"
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %exitcond.15 = icmp ne i64 %indvars.iv.next.15, 16777216
  br i1 %exitcond.15, label %for.body, label %for.end, !llvm.loop !8
