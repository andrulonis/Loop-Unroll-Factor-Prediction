; ModuleID = 'ss_sort_7_2.ll'
source_filename = "ss_sort_7_2.c"
...
for.body3:                                        ; preds = %for.body3, %for.body
  ...
  br i1 %exitcond.1, label %for.body3, label %for.inc10, !llvm.loop !9

for.inc10:                                        ; preds = %for.body3
  %indvars.iv.next5 = add nuw nsw i64 %indvars.iv4, 1
  %exitcond = icmp ne i64 %indvars.iv.next5, 131072
  br i1 %exitcond, label %for.body, label %for.end12, !llvm.loop !11
