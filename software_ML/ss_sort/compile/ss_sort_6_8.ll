; ModuleID = 'ss_sort_6_8.ll'
source_filename = "ss_sort_6_8.c"
...
for.body:                                         ; preds = %for.inc10.7, %entry
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5.7, %for.inc10.7 ]
  br label %for.body3
...
for.inc10.7:                                      ; preds = %for.body3.7
  ...
  br i1 %exitcond7.7, label %for.body, label %for.end12, !llvm.loop !10
}
