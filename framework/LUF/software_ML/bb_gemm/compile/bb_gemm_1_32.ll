; ModuleID = 'bb_gemm_1_32.ll'
source_filename = "bb_gemm_1_32.c"
...
for.body3:                                        ; preds = %for.inc17.31, %for.body
  %indvars.iv6 = phi i64 [ 0, %for.body ], [ %indvars.iv.next7.31, %for.inc17.31 ]
...
for.inc20:                                        ; preds = %for.inc17.31
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond77 = icmp ne i64 %indvars.iv.next12, 1024
  br i1 %exitcond77, label %for.body, label %for.end22, !llvm.loop !4
...
for.inc17.31:                                     ; preds = %for.body6.31
  ...
  br i1 %exitcond10.31, label %for.body3, label %for.inc20, !llvm.loop !5
}
