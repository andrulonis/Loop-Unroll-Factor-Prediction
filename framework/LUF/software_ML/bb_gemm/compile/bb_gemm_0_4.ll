; ModuleID = 'bb_gemm_0_4.ll'
source_filename = "bb_gemm_0_4.c"
...
for.body:                                         ; preds = %for.inc20.3, %entry
  %indvars.iv11 = phi i64 [ 0, %entry ], [ %indvars.iv.next12.3, %for.inc20.3 ]
  br label %for.body3
...
for.inc20.3:                                      ; preds = %for.inc17.3
  ...
  %exitcond15.3 = icmp ne i64 %indvars.iv.next12.3, 1024
  br i1 %exitcond15.3, label %for.body, label %for.end22, !llvm.loop !5
}
