; ModuleID = 'bb_gemm_1_2.ll'
source_filename = "bb_gemm_1_2.c"
...
for.inc20:                                        ; preds = %for.inc17.1
  ...
  %exitcond17 = icmp ne i64 %indvars.iv.next12, 1024
  br i1 %exitcond17, label %for.body, label %for.end22, !llvm.loop !4
...
for.inc17.1:                                      ; preds = %for.body6.1
  ...
  br i1 %exitcond10.1, label %for.body3, label %for.inc20, !llvm.loop !5
}
