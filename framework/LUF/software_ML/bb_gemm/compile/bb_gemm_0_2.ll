; ModuleID = 'bb_gemm_0_2.ll'
source_filename = "bb_gemm_0_2.c"
...
for.body:                                         ; preds = %for.inc20.1, %entry
  %indvars.iv11 = phi i64 [ 0, %entry ], [ %indvars.iv.next12.1, %for.inc20.1 ]
  br label %for.body3
...
for.inc20.1:                                      ; preds = %for.inc17.1
  ...
  %exitcond15.1 = icmp ne i64 %indvars.iv.next12.1, 1024
  br i1 %exitcond15.1, label %for.body, label %for.end22, !llvm.loop !5
}
