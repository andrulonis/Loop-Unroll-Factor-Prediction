; ModuleID = 'bb_gemm_1_8.ll'
source_filename = "bb_gemm_1_8.c"
...
for.body3:                                        ; preds = %for.inc17.7, %for.body
  %indvars.iv6 = phi i64 [ 0, %for.body ], [ %indvars.iv.next7.7, %for.inc17.7 ]
...
for.inc20:                                        ; preds = %for.inc17.7
  %indvars.iv.next12 = add nuw nsw i64 %indvars.iv11, 1
  %exitcond29 = icmp ne i64 %indvars.iv.next12, 1024
  br i1 %exitcond29, label %for.body, label %for.end22, !llvm.loop !4
...
for.inc17.7:                                      ; preds = %for.body6.7
  ...
  br i1 %exitcond10.7, label %for.body3, label %for.inc20, !llvm.loop !5
}
