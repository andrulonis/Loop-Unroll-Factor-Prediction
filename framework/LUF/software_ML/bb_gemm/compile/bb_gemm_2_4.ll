; ModuleID = 'bb_gemm_2_4.ll'
source_filename = "bb_gemm_2_4.c"
...
for.body6:                                        ; preds = %for.body6, %for.body3
  ...
  %12 = shl nsw i64 %indvars.iv13, 10
  ...
  %18 = shl nsw i64 %indvars.iv13, 10
  ...
  %24 = shl nsw i64 %indvars.iv13, 10
...
for.inc20:                                        ; preds = %for.inc17
  ...
  %exitcond20 = icmp ne i64 %indvars.iv.next14, 1024
  br i1 %exitcond20, label %for.body, label %for.end22, !llvm.loop !6
