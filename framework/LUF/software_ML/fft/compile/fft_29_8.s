...
# %bb.2:                                # %for.body3
	...
	movq	-80(%rbp), %r10         # 8-byte Reload
	shlq	$3, %r10
	movl	12(%rsi,%r10,4), %edi
	movl	%edi, 12(%rdx)
	movq	-80(%rbp), %r10         # 8-byte Reload
	shlq	$3, %r10
	movl	12(%r9,%r10,4), %edi
	movl	%edi, 12(%r8)
	movq	-80(%rbp), %r10         # 8-byte Reload
	shlq	$3, %r10
	movl	16(%rsi,%r10,4), %edi
	movl	%edi, 16(%rdx)
	movq	-80(%rbp), %r10         # 8-byte Reload
	shlq	$3, %r10
	movl	16(%r9,%r10,4), %edi
	movl	%edi, 16(%r8)
	movq	-80(%rbp), %r10         # 8-byte Reload
	shlq	$3, %r10
	movl	20(%rsi,%r10,4), %edi
	movl	%edi, 20(%rdx)
	movq	-80(%rbp), %r10         # 8-byte Reload
	shlq	$3, %r10
	movl	20(%r9,%r10,4), %edi
	movl	%edi, 20(%r8)
	movq	-80(%rbp), %r10         # 8-byte Reload
	shlq	$3, %r10
	movl	24(%rsi,%r10,4), %edi
	movl	%edi, 24(%rdx)
	movq	-80(%rbp), %r10         # 8-byte Reload
	shlq	$3, %r10
	movl	24(%r9,%r10,4), %edi
	movl	%edi, 24(%r8)
	movq	-80(%rbp), %r10         # 8-byte Reload
	shlq	$3, %r10
	movl	28(%rsi,%r10,4), %edi
	movl	%edi, 28(%rdx)
	movq	-80(%rbp), %r10         # 8-byte Reload
	shlq	$3, %r10
	movl	28(%r9,%r10,4), %edi
	movl	%edi, 28(%r8)
	movl	(%rdx), %edi
	movl	(%r8), %r11d
	movl	%edi, %ebx
