...
# %bb.20:                               # %for.end.4
	...
	movl	%esi, (%rdi)
	movl	%eax, %esi
	addl	$272, %esi              # imm = 0x110
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 4(%rdi)
	movl	%eax, %esi
	addl	$280, %esi              # imm = 0x118
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 8(%rdi)
	movl	%eax, %esi
	addl	$288, %esi              # imm = 0x120
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 12(%rdi)
	movl	%eax, %esi
	addl	$296, %esi              # imm = 0x128
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 16(%rdi)
	movl	%eax, %esi
	addl	$304, %esi              # imm = 0x130
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 20(%rdi)
	movl	%eax, %esi
	addl	$312, %esi              # imm = 0x138
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 24(%rdi)
...
# %bb.24:                               # %for.end.5
	...
	movl	%esi, (%rdi)
	movl	%eax, %esi
	addl	$338, %esi              # imm = 0x152
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 4(%rdi)
	movl	%eax, %esi
	addl	$346, %esi              # imm = 0x15A
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 8(%rdi)
	movl	%eax, %esi
	addl	$354, %esi              # imm = 0x162
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 12(%rdi)
	movl	%eax, %esi
	addl	$362, %esi              # imm = 0x16A
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 16(%rdi)
	movl	%eax, %esi
	addl	$370, %esi              # imm = 0x172
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 20(%rdi)
	...
	movl	(%r8,%r9,4), %esi
	movl	%esi, 24(%rdi)
	addl	$386, %eax              # imm = 0x182
	movl	%eax, %eax
	movl	%eax, %r9d
	movl	(%r8,%r9,4), %eax
	movl	%eax, 28(%rdi)
	movq	%rcx, -176(%rbp)        # 8-byte Spill
.LBB4_25:                               # %for.body56.5
                                        #   Parent Loop BB4_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
...
# %bb.28:                               # %for.end.6
	...
	movl	%esi, 4(%rdi)
	movl	%eax, %esi
	addl	$412, %esi              # imm = 0x19C
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 8(%rdi)
	movl	%eax, %esi
	addl	$420, %esi              # imm = 0x1A4
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 12(%rdi)
	movl	%eax, %esi
	addl	$428, %esi              # imm = 0x1AC
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 16(%rdi)
	movl	%eax, %esi
	addl	$436, %esi              # imm = 0x1B4
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 20(%rdi)
	movl	%eax, %esi
	addl	$444, %esi              # imm = 0x1BC
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 24(%rdi)
	addl	$452, %eax              # imm = 0x1C4
	movl	%eax, %eax
	movl	%eax, %r9d
	movl	(%r8,%r9,4), %eax
	movl	%eax, 28(%rdi)
	movq	%rcx, -200(%rbp)        # 8-byte Spill
.LBB4_29:                               # %for.body56.6
                                        #   Parent Loop BB4_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
...
# %bb.32:                               # %for.end.7
	...
	movl	%esi, (%rdi)
	movl	%eax, %esi
	addl	$470, %esi              # imm = 0x1D6
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 4(%rdi)
	movl	%eax, %esi
	addl	$478, %esi              # imm = 0x1DE
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 8(%rdi)
	movl	%eax, %esi
	addl	$486, %esi              # imm = 0x1E6
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 12(%rdi)
	movl	%eax, %esi
	addl	$494, %esi              # imm = 0x1EE
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 16(%rdi)
	movl	%eax, %esi
	addl	$502, %esi              # imm = 0x1F6
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 20(%rdi)
	movl	%eax, %esi
	addl	$510, %esi              # imm = 0x1FE
	movl	%esi, %esi
	movl	%esi, %r9d
	movl	(%r8,%r9,4), %esi
	movl	%esi, 24(%rdi)
	addl	$518, %eax              # imm = 0x206
	movl	%eax, %eax
	movl	%eax, %r9d
	movl	(%r8,%r9,4), %eax
	movl	%eax, 28(%rdi)
	movq	%rcx, -224(%rbp)        # 8-byte Spill
.LBB4_33:                               # %for.body56.7
                                        #   Parent Loop BB4_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
