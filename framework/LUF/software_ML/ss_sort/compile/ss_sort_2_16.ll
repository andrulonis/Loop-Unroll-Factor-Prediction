; ModuleID = 'ss_sort_2_16.ll'
source_filename = "ss_sort_2_16.c"
...
for.body:                                         ; preds = %for.body.15, %entry
  %indvars.iv = phi i64 [ 1, %entry ], [ %indvars.iv.next.15, %for.body.15 ]
  ...
  %exitcond.14 = icmp ne i64 %indvars.iv.next.14, 524288
  br i1 %exitcond.14, label %for.body.15, label %for.end, !llvm.loop !5

for.end:                                          ; preds = %for.body
  ret void

for.body.15:                                      ; preds = %for.body
...
!4 = distinct !{!4, !3}
!5 = distinct !{!5, !6}
!6 = !{!"llvm.loop.unroll.count", i32 16}
!7 = distinct !{!7, !8}
