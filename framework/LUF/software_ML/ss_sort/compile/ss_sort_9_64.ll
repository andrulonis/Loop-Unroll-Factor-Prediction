; ModuleID = 'ss_sort_9_64.ll'
source_filename = "ss_sort_9_64.c"
...
for.body3:                                        ; preds = %for.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp ne i64 %indvars.iv.next, 131072
  br i1 %exitcond, label %for.body, label %for.end19, !llvm.loop !11
