; ModuleID = 'ss_sort_0_4.ll'
source_filename = "ss_sort_0_4.c"
...
for.body:                                         ; preds = %for.inc9.3, %entry
  %indvars.iv6 = phi i64 [ 0, %entry ], [ %indvars.iv.next7.3, %for.inc9.3 ]
  br label %for.body3
...
for.inc9.3:                                       ; preds = %for.body3.3
  ...
  %exitcond10.3 = icmp ne i64 %indvars.iv.next7.3, 524288
  br i1 %exitcond10.3, label %for.body, label %for.end11, !llvm.loop !4
}
