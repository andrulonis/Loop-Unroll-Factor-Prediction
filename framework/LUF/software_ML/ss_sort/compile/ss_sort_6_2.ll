; ModuleID = 'ss_sort_6_2.ll'
source_filename = "ss_sort_6_2.c"
...
for.inc10.1:                                      ; preds = %for.body3.1
  ...
  %exitcond7.1 = icmp ne i64 %indvars.iv.next5.1, 131072
  br i1 %exitcond7.1, label %for.body, label %for.end12, !llvm.loop !10
}
