; ModuleID = 'ss_sort_6_4.ll'
source_filename = "ss_sort_6_4.c"
...
for.body:                                         ; preds = %for.inc10.3, %entry
  %indvars.iv4 = phi i64 [ 0, %entry ], [ %indvars.iv.next5.3, %for.inc10.3 ]
  br label %for.body3
...
for.inc10.3:                                      ; preds = %for.body3.3
  ...
  br i1 %exitcond7.3, label %for.body, label %for.end12, !llvm.loop !10
}
