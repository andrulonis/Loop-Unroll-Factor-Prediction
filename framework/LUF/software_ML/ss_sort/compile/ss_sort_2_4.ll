; ModuleID = 'ss_sort_2_4.ll'
source_filename = "ss_sort_2_4.c"
...
for.body:                                         ; preds = %for.body.3, %entry
  ...
  %exitcond.2 = icmp ne i64 %indvars.iv.next.2, 524288
  br i1 %exitcond.2, label %for.body.3, label %for.end, !llvm.loop !5
