; ModuleID = 'ss_sort_7_16.ll'
source_filename = "ss_sort_7_16.c"
...
for.body3:                                        ; preds = %for.body
  ...
  br i1 %exitcond, label %for.body, label %for.end12, !llvm.loop !9
