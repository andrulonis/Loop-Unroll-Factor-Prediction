...
for.body:                                         ; preds = %for.end.3, %entry
  %indvars.iv7 = phi i64 [ 0, %entry ], [ %indvars.iv.next8.3, %for.end.3 ]
...
for.end.3:                                        ; preds = %for.body7.3
  ...
  %exitcond10.3 = icmp ne i64 %indvars.iv.next8.3, 1024
  br i1 %exitcond10.3, label %for.body, label %for.end43, !llvm.loop !4
}
