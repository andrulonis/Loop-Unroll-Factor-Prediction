; ModuleID = 'stencil_0_2.ll'
source_filename = "stencil_0_2.c"
...
for.body:                                         ; preds = %for.inc78.1, %entry
  %indvars.iv12 = phi i64 [ 0, %entry ], [ %indvars.iv.next13.1, %for.inc78.1 ]
  br label %for.body3
...
for.inc78.1:                                      ; preds = %for.body3.1
  ...
  br i1 %exitcond15.1, label %for.body, label %for.end80, !llvm.loop !4
}
