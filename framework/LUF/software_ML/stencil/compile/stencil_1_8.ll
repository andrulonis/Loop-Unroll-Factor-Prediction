; ModuleID = 'stencil_1_8.ll'
source_filename = "stencil_1_8.c"
...
for.body3:                                        ; preds = %for.body3.6, %for.body
  %indvars.iv = phi i64 [ 0, %for.body ], [ %indvars.iv.next.7, %for.body3.6 ]
  ...
  br i1 %exitcond.5, label %for.body3.6, label %for.inc78, !llvm.loop !2
