; ModuleID = 'pp_scan_3_8.ll'
source_filename = "pp_scan_3_8.c"
...
for.body:                                         ; preds = %for.inc11.7, %entry
  %indvars.iv5 = phi i64 [ 0, %entry ], [ %indvars.iv.next6.7, %for.inc11.7 ]
  br label %for.body3
...
for.inc11.7:                                      ; preds = %for.body3.7
  ...
  %exitcond10.7 = icmp ne i64 %indvars.iv.next6.7, 524288
  br i1 %exitcond10.7, label %for.body, label %for.end13, !llvm.loop !7
}
