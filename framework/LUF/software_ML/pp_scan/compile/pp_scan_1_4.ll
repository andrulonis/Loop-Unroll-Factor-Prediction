; ModuleID = 'pp_scan_1_4.ll'
source_filename = "pp_scan_1_4.c"
...
for.body3:                                        ; preds = %for.body3.3, %for.body
  %indvars.iv = phi i64 [ 1, %for.body ], [ %indvars.iv.next.3, %for.body3.3 ]
  ...
  br i1 %exitcond.2, label %for.body3.3, label %for.inc9, !llvm.loop !2
