; ModuleID = 'unroll_no_auto_all/pp_scan.ll'
...
for.inc9.1:                                       ; preds = %for.body3.117
  ...
  %exitcond12.1 = icmp ne i64 %indvars.iv.next7.1, 524288
...
for.body3.1:                                      ; preds = %for.body3.1, %for.inc11
  ...
  %arrayidx10.115 = getelementptr inbounds i32, i32* %bucket2, i64 %17
  ...
  %arrayidx10.1.1 = getelementptr inbounds i32, i32* %bucket2, i64 %23
...
for.inc11.1:                                      ; preds = %for.body3.1
  ...
  %exitcond.117 = icmp ne i64 %indvars.iv.next6.1, 524288
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv.next, 1
  %exitcond.1 = icmp ne i64 %indvars.iv.next.1, 8388608
