...
for.inc9:                                         ; preds = %for.body3
  ...
  %exitcond12 = icmp ne i64 %indvars.iv.next7, 128
  br i1 %exitcond12, label %for.body, label %for.end11
...
for.body3:                                        ; preds = %for.body3, %for.body
  ...
  br i1 %exitcond.1, label %for.body3, label %for.inc11

for.inc11:                                        ; preds = %for.body3
  %indvars.iv.next6 = add nuw nsw i64 %indvars.iv5, 1
  %exitcond = icmp ne i64 %indvars.iv.next6, 128
  br i1 %exitcond, label %for.body, label %for.end13
...
for.body:                                         ; preds = %for.body, %entry
  ...
  %exitcond.7 = icmp ne i64 %indvars.iv.next.7, 2048
  br i1 %exitcond.7, label %for.body, label %for.end
...
for.body3:                                        ; preds = %for.body
  ...
  br i1 %exitcond, label %for.body, label %for.end12
...
for.body3:                                        ; preds = %for.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond = icmp ne i64 %indvars.iv.next, 512
  br i1 %exitcond, label %for.body, label %for.end19
