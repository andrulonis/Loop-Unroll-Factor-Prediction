...
for.body:                                         ; preds = %for.body, %entry
  %indvars.iv3 = phi i64 [ 0, %entry ], [ %indvars.iv.next4.7, %for.body ]
  ...
  %exitcond.75 = icmp ne i64 %indvars.iv.next4.7, 2048
  br i1 %exitcond.75, label %for.body, label %for.end, !llvm.loop !4
...
for.body18:                                       ; preds = %for.body18, %for.end
  %indvars.iv = phi i64 [ 0, %for.end ], [ %indvars.iv.next.7, %for.body18 ]
  ...
  %indvars.iv.next.7 = add nuw nsw i64 %indvars.iv.next.6, 1
  %exitcond.7 = icmp ne i64 %indvars.iv.next.7, 2048
  br i1 %exitcond.7, label %for.body18, label %for.end24, !llvm.loop !5
