...
# %bb.2:                                # %for.body9.preheader
	xorl	%eax, %eax
	movl	%eax, %ecx
	movq	%rcx, -4223008(%rbp)    # 8-byte Spill
	jmp	.LBB4_3
.LBB4_3:                                # %for.body9
                                        # =>This Loop Header: Depth=1
...
.LBB4_4:                                # %for.body12
	...
	movq	-4223016(%rbp), %rcx    # 8-byte Reload
	shlq	$12, %rcx
...
# %bb.5:                                # %for.inc20
	...
	movq	%rcx, -4223040(%rbp)    # 8-byte Spill
	jmp	.LBB4_15
.LBB4_6:                                # %for.end22
	...
	xorl	%r8d, %r8d
	movl	%r8d, %ecx
	movq	%rcx, -4223048(%rbp)    # 8-byte Spill
.LBB4_7:                                # %for.body29
                                        # =>This Loop Header: Depth=1
...
.LBB4_8:                                # %for.body32
	...
	movq	-4223056(%rbp), %rcx    # 8-byte Reload
	shlq	$12, %rcx
	leaq	-4218880(%rbp), %rdx
	movq	%rdx, %rsi
	addq	%rcx, %rsi
...
# %bb.9:                                # %for.inc42
	...
	movq	%rcx, -4223080(%rbp)    # 8-byte Spill
	jmp	.LBB4_13
.LBB4_10:                               # %for.end44
...
.LBB4_11:                               # %for.body54
	...
	movb	$0, %al
	callq	printf
	movq	-4223096(%rbp), %rdi    # 8-byte Reload
	addq	$1, %rdi
	movq	-4223096(%rbp), %r8     # 8-byte Reload
