...
for.inc17:                                        ; preds = %for.body6
  ...
  %exitcond10 = icmp ne i64 %indvars.iv.next7, 8
  br i1 %exitcond10, label %for.body3, label %for.inc20
...
entry:
  ...
  %call2 = call noalias dereferenceable_or_null(4096) i8* @malloc(i64 4096) #4
